                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                        <form class="form-header" action="{{ url('admin/petugas') }}" method="GET">
                                        ...
                                        <!-- <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                            ...
                                            <div class="rs-select2--dark rs-select2--sm rs-select2--dark2 dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                    <a class="dropdown-item" href="{{ route('petugas.pdf') }}">PDF</a>
                                                    <a class="dropdown-item" href="{{ route('petugas.excel') }}">Excel</a>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        ...
                                                        <a href="{{url('admin/petugas/edit/'.$user->id)}}" type="button" class="btn item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="{{ url('admin/petugas/delete/'.$user->id) }}" class="btn btn-danger">Hapus</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
